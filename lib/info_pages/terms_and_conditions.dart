      ...
      body: Padding(
          ...
          child: Column(
            ...
            children: const [
              ...
              SizedBox(height: 8),
              Text(
                'By clicking the "Agree" button below, you acknowledge that you have read and understood these terms and conditions and agree to be bound by them. If you do not agree to these terms and conditions, please do not use this application.',
                style: TextStyle(fontSize: 16),
              ),
            ],
          )),
