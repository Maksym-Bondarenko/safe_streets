...
class _LoadingSpinnerWidgetState extends State<LoadingSpinnerWidget> with SingleTickerProviderStateMixin {
        ...
        AnimatedBuilder(
          ...
          builder: (BuildContext context, Widget? child) {
            return Transform.rotate(
              angle: _rotationAnimation.value * 2 * 3.1415, // Convert rotation to radians
              child: CustomPaint(
...
class _LoadingPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var i = 0; i < dotCount; i++) {
      ...
      canvas.drawLine(Offset(startX, startY), Offset(endX, endY), dottedCirclePaint);
    }

    // Draw the solid circle line
    final solidCircleRect = Rect.fromCircle(center: center, radius: radius - strokeWidth);
