...
import 'package:safe_streets/screens/common/components/dropdown_input_field.dart';
import 'package:safe_streets/screens/common/components/primary_button.dart';
import 'package:safe_streets/screens/common/components/text_input_field.dart';
...
class AddCustomPointDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _AddCustomPointDialogState();
}
...
class _AddCustomPointDialogState extends ConsumerState<AddCustomPointDialog> {
  ...
  final _mainTypes = PointType.values.where((t) => t is! SafePointType).map((t) => t.mainType).toSet();
